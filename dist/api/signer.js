...
export function signRequest(opts) {
    ...
    const request = {
        ...
        path: url.pathname,
        body: body,
        headers: Object.assign({ 'Content-Type': contentType, 'Host': url.hostname, 'Content-Length': Buffer.byteLength(body), 'X-Amz-Security-Token': sessionToken, 'X-Amz-Date': datetime }, headers)
    };
